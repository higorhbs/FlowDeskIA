...
const DEFAULT: BusinessVocabulary = {
  ...
  catalogEmptyHint: "Adicione serviços ou produtos para o bot enviar no WhatsApp.",
...
const BY_TYPE: Record<BusinessType, BusinessVocabulary> = {
  BARBERSHOP: {
    ...
    catalogEmptyHint: "Adicione cortes e serviços para o bot enviar no WhatsApp.",
  },
  SALON: {
    ...DEFAULT,
    ...
    catalogItemSingular: "serviço",
    catalogEmptyHint: "Adicione serviços do salão para o bot enviar no WhatsApp.",
  },
  RESTAURANT: {
    ...DEFAULT,
    ...
    catalogEmptyHint: "Cadastre pratos e bebidas para o bot enviar no WhatsApp.",
  ...
  DENTAL: {
    ...
    catalogItemSingular: "serviço",
    catalogEmptyHint: "Cadastre tratamentos e valores para o bot enviar no WhatsApp.",
  ...
  STORE: {
    ...
    catalogEmptyHint: "Cadastre produtos para o bot enviar no WhatsApp.",
